...
public class UserDAO {
	...
	private static final String query = "INSERT INTO employee" + "  (ename, doj, yoe, designation) VALUES "
			+ " (?, ?, ?, ?);";
	...
	public static void insertUser(User user) throws SQLException, ClassNotFoundException {
		...
		try (Connection connection = DBConnect.getConnection();
			...
			preparedStatement.setString(2, user.getDoj());
			preparedStatement.setString(3, user.getYoe());
